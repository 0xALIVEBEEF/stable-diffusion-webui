...
class Processed:
    ...
    def js(self):
        obj = {
            ...
            "go_to_convergence": self.go_to_convergence,
            "default_convergence_tolerance": self.default_convergence_tolerance,
            "reduce_convergence_tolerance_step": self.reduce_convergence_tolerance_step,
            "reduced_convergence_tolerance": self.reduced_convergence_tolerance
        }
